  ...
  return (
    <AppBar position="fixed" className="navbar"> {/* Apply the CSS class here */}
      <Toolbar>
        ...
        <Button color="inherit" onClick={(e) => setAdminAnchor(e.currentTarget)}>Admin</Button>
        ...
        <Button color="inherit" onClick={(e) => setEmployeeAnchor(e.currentTarget)}>Employee</Button>
